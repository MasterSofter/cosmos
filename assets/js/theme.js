...
(function () {
	...
	*/
	...
	if (document.documentElement.clientWidth > 768) {
	  // по факту надо поставить 992, но на случай переключения ориентации ipad оставил 768
	  ...
	  swiperYourself.on('activeIndexChange', function () {
	    const index = Number.isInteger(swiperYourself.activeIndex / 4) ? swiperYourself.activeIndex / 4 : Math.floor(swiperYourself.activeIndex / 4);
